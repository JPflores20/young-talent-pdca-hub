      ...
      <div className="flex min-h-screen w-full items-center justify-center bg-background p-4">
        <div className="mx-auto w-full max-w-md rounded-2xl border border-green-500/20 bg-green-50/50 p-8 text-center shadow-lg dark:bg-green-950/20">
          ...
          <p className="mb-6 text-sm text-green-600/80 dark:text-green-400/80">
            Hemos enviado un correo de verificación oficial a <strong>{regEmail}</strong>. Por
            razones de seguridad, debes activar tu cuenta desde tu bandeja de entrada antes de poder
  ...
  return (
    <div className="relative flex min-h-screen w-full overflow-hidden bg-background">
      ...
      <div className="absolute inset-0 flex w-full">
        ...
        <div
          className={`flex w-full lg:w-1/2 items-center justify-center transition-all duration-700 ease-in-out ${isRegistering ? "-translate-x-[100%] opacity-0 pointer-events-none absolute" : "translate-x-0 opacity-100 relative z-10"}`}
        >
        ...
        <div
          className={`flex w-full lg:w-1/2 items-center justify-center transition-all duration-700 ease-in-out absolute top-0 bottom-0 right-0 ${isRegistering ? "opacity-100 z-10 scale-100 pointer-events-auto" : "opacity-0 z-0 scale-95 pointer-events-none"}`}
        >
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <div className="space-y-1 sm:col-span-2">
                    ...
                    <Input
                      ...
                      required
                      value={nombre}
                      onChange={handleUppercase(setNombre)}
                  ...
                  <div className="space-y-1">
                    ...
                    <Input
                      ...
                      required
                      value={paterno}
                      onChange={handleUppercase(setPaterno)}
                      placeholder="LOPEZ"
                    />
                  </div>
                  <div className="space-y-1">
                    ...
                    <Input
                      id="materno"
                      value={materno}
                      onChange={handleUppercase(setMaterno)}
      ...
      <div
        className={`hidden lg:flex absolute top-0 left-0 h-full w-1/2 bg-gradient-to-b from-[#0a1428] via-[#0f1c38] to-[#080e1e] text-white z-20 transition-transform duration-700 ease-in-out shadow-2xl items-center justify-center overflow-hidden ${isRegistering ? "translate-x-0" : "translate-x-full"}`}
      >
        ...
        <div
          className={`absolute inset-0 flex flex-col p-16 transition-all duration-700 ease-in-out ${isRegistering ? "opacity-0 translate-x-16 pointer-events-none" : "opacity-100 translate-x-0 delay-100"}`}
        >
        ...
        <div
          className={`absolute inset-0 flex flex-col p-16 transition-all duration-700 ease-in-out ${isRegistering ? "opacity-100 translate-x-0 delay-100" : "opacity-0 -translate-x-16 pointer-events-none"}`}
        >
          <div className="flex flex-col flex-1 justify-center items-start">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-white/80 mb-6">
              Cultura MAZ
