/**
 * Datos de seed para el desarrollo y la inicialización de Firestore.
 * Contiene PDCAs de ejemplo usados cuando la colección está vacía.
 *
 * NOTA: Este módulo sólo debe importarse desde el servicio de seeding
 * (`pdca-seed-service.ts`). No importar directamente en componentes.
 */
import type { Pdca } from "./pdca-types";

export const SEED_PDCAS: Pdca[] = [
  {
    id: "PDCA-2026-014",
  ...
  },
  {
    ...
    estandarizacion: "",
    indicador: {
      etiqueta: "Horas de captura / semana",
      antes: 10.5,
      despues: 10.5,
      unidad: "h",
    },
  ...
  },
  {
    ...
    estandarizacion: "",
    indicador: {
      etiqueta: "Despliegues con hotfix",
      antes: 30,
      despues: 30,
      unidad: "%",
    },
